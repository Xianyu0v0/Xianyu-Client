...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener
{
    ...
    {
        return this.entityOutlineFramebuffer != null && this.entityOutlineShader != null && this.mc.thePlayer != null && this.mc.thePlayer.isSpectator() && this.mc.gameSettings.keyBindStreamStartStop.isKeyDown();
    }
        ...
        else
        {
            ...
            if (this.isRenderEntityOutlines())
            {
                ...
                for (int j = 0; j < list.size(); ++j)
                {
                    ...
                    if ((entity3 != this.mc.getRenderViewEntity() || this.mc.gameSettings.showDebugInfo != 0 || flag) && flag1)
                    {
                ...
                if (!classinheritancemultimap.isEmpty())
                {
                    ...
                    while (true)
                    {
                        ...
                        while (true)
                        {
                            ...
                            if ((entity2 != this.mc.getRenderViewEntity() || this.mc.gameSettings.showDebugInfo != 0 || flag3) && (entity2.posY < 0.0D || entity2.posY >= 256.0D || this.theWorld.isBlockLoaded(new BlockPos(entity2))))
                            {
                                ++this.countEntitiesRendered;
