...
import xyz.xianyu.util.Font.CFont;
    ...
    public List<String> wrapWords(String text, double width) {
        ...
        if ((double)this.getStringWidth(text) > width) {
            ...
            for (String word : words) {
                ...
                StringBuilder stringBuilder = new StringBuilder(String.valueOf(String.valueOf(currentWord)));
    ...
    public List<String> formatString(String string, double width) {
        ...
        for (int i = 0; i < chars.length; ++i) {
            ...
            if ((double)this.getStringWidth(stringBuilder.append(c).toString()) < width) {
                currentWord = String.valueOf(String.valueOf(currentWord)) + c;
                continue;
            }
            finalWords.add(currentWord);
            currentWord = String.valueOf(String.valueOf(167 + lastColorCode)) + String.valueOf(c);
        }
        if (currentWord.length() > 0) {
            finalWords.add(currentWord);
        }
