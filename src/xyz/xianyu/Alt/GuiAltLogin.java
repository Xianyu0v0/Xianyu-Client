...
extends GuiScreen {
    ...
    public void drawScreen(int x, int y, float z) {
        ...
        Helper.mc.fontRendererObj.drawString("Alt Login", this.width / 2, 20, -1);
        Helper.mc.fontRendererObj.drawString(this.thread == null ? "\u00a7eWaiting..." : this.thread.getStatus(), this.width / 2, 29, -1);
