...
extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.drawDefaultBackground();
        Helper.mc.fontRendererObj.drawStringWithShadow(GuiAltManager.mc.session.getUsername(), 10, 10, -7829368);
        
        Helper.mc.fontRendererObj.drawString("Account Manager - " + AltManager.getAlts().size() + " alts", this.width / 2, 10, -1);
        Helper.mc.fontRendererObj.drawString(this.loginThread == null ? this.status : this.loginThread.getStatus(), this.width / 2, 20, -1);
        GL11.glPushMatrix();
        ...
        for (Alt alt : AltManager.getAlts()) {
            ...
            if (alt == this.selectedAlt) {
                if (this.isMouseOverAlt(par1, par2, y - this.offset) && Mouse.isButtonDown((int)0)) {
                    RenderUtil.drawBorderedRect(52, y - this.offset - 4, this.width - 52, y - this.offset + 20, 1, -16777216, -2142943931);
                } else if (this.isMouseOverAlt(par1, par2, y - this.offset)) {
                    RenderUtil.drawBorderedRect(52, y - this.offset - 4, this.width - 52, y - this.offset + 20, 1, -16777216, -2142088622);
                } else {
                    RenderUtil.drawBorderedRect(52, y - this.offset - 4, this.width - 52, y - this.offset + 20, 1, -16777216, -2144259791);
                }
            } else if (this.isMouseOverAlt(par1, par2, y - this.offset) && Mouse.isButtonDown((int)0)) {
                RenderUtil.drawBorderedRect(52, y - this.offset - 4, this.width - 52, y - this.offset + 20, 1, -16777216, -2146101995);
            } else if (this.isMouseOverAlt(par1, par2, y - this.offset)) {
                RenderUtil.drawBorderedRect(52, y - this.offset - 4, this.width - 52, y - this.offset + 20, 1, -16777216, -2145180893);
            }
            Helper.mc.fontRendererObj.drawString(name, this.width / 2, y - this.offset, -1);
            Helper.mc.fontRendererObj.drawString(pass, this.width / 2, y - this.offset + 10, 0x555555);
            y += 26;
        }
